...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {/* ── Right Panel ── */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 py-12" style={{ backgroundColor: "#f5f8fb" }}>
        <div className="max-w-md mx-10">
              ...
              <div className="bg-white rounded-lg p-8 max-w-sm w-full mx-4">
                ...
                {resetSuccess ? (
                  <div
                    ...
                    style={{ background: "#ecfdf5", color: "#065f46", border: "1px solid #86efac" }}
                  >
                  ...
                  <>
                    ...
                    <input
                      ...
                      style={{
                        borderColor: forgotEmail && !validateEmail(forgotEmail) ? "#dc2626" : "#d1d5db",
                        backgroundColor: "#ffffff"
                      }}
                      onFocus={(e) => (e.target.style.borderColor = "#0052cc")}
                      onBlur={(e) => (e.target.style.borderColor = forgotEmail && !validateEmail(forgotEmail) ? "#dc2626" : "#d1d5db")}
                    />
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => !forgotLoading && (e.target.style.background = "#111827")}
                      onMouseLeave={(e) => !forgotLoading && (e.target.style.background = "#1f2937")}
                    >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Welcome back! Sign in to continue tracking your applications</p>
          </div>
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <Link to="/signup" className="font-bold" style={{ color: "#0052cc" }}>
              Sign up
            </Link>
          </p>
